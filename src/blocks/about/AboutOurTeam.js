            ...
            <div className="row gutter-width-sm with-pb-md flex justify-around">
                    ...
                    <div className="team-member">
                        <div className="img object-fit">
                            <div className="object-fit-cover">
                                <img src="assets/img/placeholder/507x600.jpg" alt="Rick Norman" />
                            </div>
                        </div>
                        ...
                        <div className="team-member-content">
                            ...
                            <h4 className="team-member-t-head">Sally</h4>
                ...
                <div className="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                    <div className="team-member">
                        <div className="img object-fit">
                            <div className="object-fit-cover">
                                <img src="assets/img/placeholder/507x600.jpg" alt="Johnathan" />
                            </div>
                        </div>
